...
?>
        <section>
            <article class="top">
                ...
                <ul>
                    <li><strong>NAME</strong>한소담</li>
                    <li><strong>BIRTH</strong>1992.10.20</li>
                    <li><strong>EDUCATION</strong>2019.12 ~ 2020.06 강남 그린컴퓨터 아카데미
                        웹퍼블리셔/프론트엔드 교육과정 수료</li>
                    <li><strong>CERTIFICATE</strong>정보기기운용기능사</li>
                </ul>
                <p><img src="asset/img/face.png" alt=""></p>
            </article>
            ...
            <article class="bottom">
                ...
                <ul>
                    ...
                    <li><strong>PHP, MYSQL</strong>(DML) 게시판 생성 및 게시물 작성, 수정, 삭제
                        관리자 로그인기능 구현
                        </li>
                </ul>
            </article>
